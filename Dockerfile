...
RUN \
  ...
  && cp "$TEMP_SYSLINUX_PATH"/efi64/efi/syslinux.efi /var/lib/tftpboot/ \
  && cp "$TEMP_SYSLINUX_PATH"/efi64/com32/libutil/libutil.c32 /var/lib/tftpboot/ \
  && cp "$TEMP_SYSLINUX_PATH"/efi64/com32/elflink/ldlinux/ldlinux.e64 /var/lib/tftpboot/ \
  && cp "$TEMP_SYSLINUX_PATH"/efi64/com32/menu/menu.c32 /var/lib/tftpboot/ \
